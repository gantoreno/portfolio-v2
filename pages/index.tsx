        ...
        <main>
          ...
          <Section>
            ...
            <Paragraph>
              ...
              project assessments. Here&apos;s a brief overview of my journey as
              a developer:
            </Paragraph>
            <Timeline>
              <Timeline.Item>
                ...
                >
                  ...
                  engineered new manual and automatized systems for the
                  different areas of the hiring process, engineered new feature
                  for the hiring tooling backing our processesm as well as
                  designed and built new technical assessments for the
                  engineering roles.
                </Experience>
              </Timeline.Item>
              <Timeline.Item>
              ...
              <Timeline.Item>
                ...
                >
                  ...
                  React.js, led the engineering team for a custom
                  high-performant streaming service, created &amp; maintained
                  the company&apos;s web media player for live video &amp;
                  signal broadcasting with Next.js, and implemented custom
                  software solutions for DNS management.
                </Experience>
              </Timeline.Item>
              <Timeline.Item>
                <Experience position="Software Engineer" year="Jan 2020">
                  ...
                  and mplemented custom bash routines for server tasks, as well
                  as custom RouterOS scripts for managing a client&apos;s
                  connection status &amp; a speed test utility.
                </Experience>
              </Timeline.Item>
              <Timeline.Item>
                <Experience position="Frontend Engineer" year="Apr 2019">
                  ...
                  mission, vision, and values, and implemented new visual
                  designs on their customer portal to match it with the
                  company&apos;s design language &amp; corporate identity.
                </Experience>
              </Timeline.Item>
              <Timeline.Item>
                <Experience
                ...
                >
                  ...
                  company&apos;s clients with React, developed the
                  company&apos;s project management system through PHP with the
                  Laravel framework with roles, tasks &amp; comments, as well as
                  template showcasing for client presentations, optimizing
                  development times &amp; time tracking routines by 37%, and
                  configured the company&apos;s project storage server &amp;
                  linked it with the project management system for full remote
                  access to their projects &amp; templates.
                </Experience>
              </Timeline.Item>
              <Timeline.Item>
          ...
          <Section>
            ...
            <Paragraph>
              ...
              ai-related stuff &amp; small interesting projects. Some of them
              are:
            </Paragraph>
          ...
          <Section>
            ...
            <Paragraph>
              ...
              compile most of the important things I&apos;ve learned and
              experienced during my whole coding journey, so stay tuned for
              that!
            </Paragraph>
            <Paragraph>
